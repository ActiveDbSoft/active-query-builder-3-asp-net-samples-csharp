...
AQB.Web.UI.QueryBuilder(instanceId, qb, { host: 'http://localhost:1066' });
...
AQB.Web.UI.startApplication('http://localhost:1066/CreateQueryBuilder/CreateQueryBuilder', instanceId);
